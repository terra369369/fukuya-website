...
- **LP制作の公開価格(2026-08-02決定):** 初回制作費¥59,800(税抜。企画・原稿作成/デザイン・スマホ対応/AI検索(AIO)・SEO・MEO対策一式/公開設定)+月額¥9,800(税抜。維持・管理/メニュー・写真の月次更新)。#spotsに相場3階層との比較セクションあり(出典表記: Web幹事・STOCK SUN等 2026年。相場を盛らないこと)。価格変更時はFAQ表示・FAQPage/ProfessionalService JSON-LDも同期
